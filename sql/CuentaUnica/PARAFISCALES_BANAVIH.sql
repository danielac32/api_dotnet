...
FROM PAGO P, DET_PAGO_IMPUTADO PI, ORGANISMO O,PLAN_UNICO_CTA PU, FUENTE_FINANCIAMIENTO F,PAGO_IMPUTADO PA ,SEGUIMIENTO_PAGO SP 
WHERE P.PAGO_ID = PI.PAGO_ID 
  ...
  AND (pa.CTA_BANC_AUTORI = '0001-0001-30-4430002017' OR pa.CTA_BANC_BENEF = '0001-0001-30-4430002017')
